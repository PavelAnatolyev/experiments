================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : RILSample Project Overview
===============================================================================

The application wizard has created this RILSample application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your RILSample application.
...
RILSample.h
    ...
    project specific headers and declares the CRILSampleApp application class.
...
RILSampleDlg.h, RILSampleDlg.cpp - the dialog
    These files contain your CRILSampleDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named RILSample.pch and a precompiled types file named StdAfx.obj.
