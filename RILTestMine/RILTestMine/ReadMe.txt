================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : RILTestMine Project Overview
===============================================================================

The application wizard has created this RILTestMine application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your RILTestMine application.
...
RILTestMine.h
    ...
    project specific headers and declares the CRILTestMineApp application class.

RILTestMine.cpp
    This is the main application source file that contains the application
    class CRILTestMineApp.
...
RILTestMineDlg.h, RILTestMineDlg.cpp - the dialog
    These files contain your CRILTestMineDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named RILTestMine.pch and a precompiled types file named StdAfx.obj.
